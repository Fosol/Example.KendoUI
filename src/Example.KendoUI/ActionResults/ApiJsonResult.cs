...
namespace Example.KendoUI.ActionResults
{
    ...
    /// </summary>
    public class ApiJsonResult : ApiObjectResult
    {
        #region Properties

        /// <summary>
        /// get/set - The HTTP ContentType - defaults to "application/json".
        /// </summary>
        public MediaTypeHeaderValue ContentType { get; set; } = new MediaTypeHeaderValue("application/json") { Encoding = Encoding.UTF8 };
        #endregion
        ...
        public ApiJsonResult(object value, string eTag) : base(value, eTag)
        {
            this.ETag = eTag;
        }
        #endregion
